          ...
          <form action="{{url('updaterestaurant')}}"  method="post" enctype="multipart/form-data">
            ...
            <div class="box-body"> 
              ...
              <div class="form-group">
                ...
                <input type="file" name="image" required  value="{{ $profile->image}}"> 
              </div> 
              ...
              <div class="form-group">
                ...
                <input re type="checkbox" name="working_days[]" value="sunday" @if($profile->working_days=='sunday') checked  / @endif>Sunday &nbsp;&nbsp;&nbsp;&nbsp; 
              </div> 
              <div class="form-group">
