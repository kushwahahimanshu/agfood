@extends('master')
@section('title','Show all Restaurant') 
@section('main_body')
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><b>View All Delivery Boy For Approval</b></h3><!-- 
          <a href="{{url('admin')}}" class="btn btn-sm btn-success" style="float:right;">Add Restaurant</a> -->
        </div><!-- /.box-header -->
        <div class="box-body">
              ...
              <tbody> 
                ...
                @foreach($forms as $form)
                  <tr> 
                    ...
                    <td> 
                      <a href="{{url('approval/'.$form->userid)}}"><button type="button" class="btn btn-md">Approve Now</button></a>
                     <!--  <form action="{{url('admin/'.$form->id)}}" method="post" class="pull-right">
                      {{csrf_field()}}
                      {{method_field("DELETE")}}
