...
{             
    ...
    Route::get('allbanner','AdminController@showbanner');  // it is a show/all banner view route
    ...
    Route::get('choose-category','MenuController@choosecategory');
    Route::post('cuisine-category','MenuController@cuisinecategory'); 
    Route::get('delete-banner/{id}', 'AdminController@deleteBanner');
...
Route::get('password-reset/{token}','HomePageController@passwordreset');
Route::post('submit','HomePageController@submit');
Route::get('thank','HomePageController@thank');
